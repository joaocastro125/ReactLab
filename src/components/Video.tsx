             ...
             <div className="p-8 max-w-[860px] mx-auto">
                <div className="flex items-start gap-16">
                    <div className="flex-1">
                        ...
                        <p className="mt-4 text-gray-400 leading-relaxed">
                            ...
                            <div className="leading-relaxed">
                                ...
                                <span className="text-gray-200 text-sm block">CTO @Rockeseat</span>
                            </div>
                    </div>
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-4">
                        <a href="" className="p-4 text-sm border text-blue-500 border-blue-500 flex items-center rounded font-bold uppercase gap-2 justify-center hover:bg-blue-500  hover:text-gray-500 transition-colors">
                            <Lightning size={24} />
                            Acesse o desafio
