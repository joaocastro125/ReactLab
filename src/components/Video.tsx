    ...
    return ( 
        <div className="flex-1">
            <div className="bg-black flex justify-center">
             <div className="h-full w-full max-w-[860px] max-h-[60vh]  aspect-video"></div>
             </div>
             <div className="p-8 max-w-[800px] mx-auto">
                <div className="flex items-start gap-16">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-4">
                        <a href="" className="p-4 text-sm border text-blue-500 border-blue-500 flex items-center rounded font-bold uppercase gap-2 justify-center">
                            <Lightning size={20} />
                            Acesse o desafio
